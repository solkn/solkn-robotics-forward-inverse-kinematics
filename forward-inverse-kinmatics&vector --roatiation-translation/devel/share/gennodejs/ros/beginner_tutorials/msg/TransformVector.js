...
class TransformVector {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TransformVector
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TransformVector
    let len;
    let data = new TransformVector(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TransformVector(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = TransformVector;
