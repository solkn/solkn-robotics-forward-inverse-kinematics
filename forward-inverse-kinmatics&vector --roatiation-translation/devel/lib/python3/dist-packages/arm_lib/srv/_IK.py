...
class IKRequest(genpy.Message):
  _md5sum = "6c49257596f64e9170834568343a78b7"
  _type = "arm_lib/IKRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[] actuator_pose
float64[] joint_positions
"""
  __slots__ = ['actuator_pose','joint_positions']
...
class IKResponse(genpy.Message):
  _md5sum = "de7aa94c5f3c8ec24a0480233313146b"
  _type = "arm_lib/IKResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[] new_angles
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.new_angles = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class IK(object):
  _type          = 'arm_lib/IK'
  _md5sum = '1ddfd34f87b4b1bd0603440253b8c447'
